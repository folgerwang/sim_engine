...
Categories:
- FLOOR: walkable surfaces. Roads, sidewalks, pavement, floor tiles, doormats, interior floors.
- WALL: blocking vertical surfaces. Brick, plaster, stucco, exterior cladding, roof shingles (treat roofs as Wall for blocking).
...
- CEILING: blocks-from-below. Interior ceilings, ceiling fans (only the ceiling part), roof underside.
