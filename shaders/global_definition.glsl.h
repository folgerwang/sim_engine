...
#define DST_COLOR_TEX_INDEX         (OCCLUSION_TEX_INDEX + 1)
#define DST_WEIGHT_TEX_INDEX        (DST_COLOR_TEX_INDEX + 1)
#define SRC_WEIGHT_TEX_INDEX        (DST_WEIGHT_TEX_INDEX + 1)

#define CONEMAP_TEX_INDEX           (SRC_WEIGHT_TEX_INDEX + 1)
