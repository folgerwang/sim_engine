...
#define ALBEDO_TEX_INDEX            (PBR_CONSTANT_INDEX + 1) // 8
#define NORMAL_TEX_INDEX            (ALBEDO_TEX_INDEX + 1)  // 9
#define METAL_ROUGHNESS_TEX_INDEX   (NORMAL_TEX_INDEX + 1) // 10
#define EMISSIVE_TEX_INDEX          (METAL_ROUGHNESS_TEX_INDEX + 1) // 11
#define OCCLUSION_TEX_INDEX         (EMISSIVE_TEX_INDEX + 1) // 12
#define SPECULAR_TEX_INDEX          (OCCLUSION_TEX_INDEX + 1) // 13
#define DIFFUSE_TEX_INDEX           ALBEDO_TEX_INDEX // 8    
#define GLOSSNESS_TEX_INDEX         METAL_ROUGHNESS_TEX_INDEX // 10
#define DST_COLOR_TEX_INDEX         (SPECULAR_TEX_INDEX + 1) // 14
#define DST_WEIGHT_TEX_INDEX        (DST_COLOR_TEX_INDEX + 1) // 15
#define SRC_WEIGHT_TEX_INDEX        (DST_WEIGHT_TEX_INDEX + 1) // 16

#define CONEMAP_TEX_INDEX           (SRC_WEIGHT_TEX_INDEX + 1) // 17
#define PRT_PACK_TEX_INDEX          (CONEMAP_TEX_INDEX + 1) // 18
#define PRT_PACK_INFO_TEX_INDEX     (PRT_PACK_TEX_INDEX + 1) // 19
...
#define DST_SOIL_WATER_LAYER_BUFFER_INDEX   (TILE_BASE_PARAMS_INDEX + 0) // 6
#define DST_WATER_NORMAL_BUFFER_INDEX       (TILE_BASE_PARAMS_INDEX + 1) // 7
#define DST_WATER_FLOW_BUFFER_INDEX         (TILE_BASE_PARAMS_INDEX + 2) // 8
#define SRC_COLOR_TEX_INDEX                 (TILE_BASE_PARAMS_INDEX + 3) // 9
#define SRC_DEPTH_TEX_INDEX                 (TILE_BASE_PARAMS_INDEX + 4) // 10
#define ROCK_LAYER_BUFFER_INDEX             (TILE_BASE_PARAMS_INDEX + 5) // 11
#define SOIL_WATER_LAYER_BUFFER_INDEX       (TILE_BASE_PARAMS_INDEX + 6) // 12
#define ORTHER_INFO_LAYER_BUFFER_INDEX      (TILE_BASE_PARAMS_INDEX + 7) // 13
#define WATER_NORMAL_BUFFER_INDEX           (TILE_BASE_PARAMS_INDEX + 8) // 14
#define WATER_FLOW_BUFFER_INDEX             (TILE_BASE_PARAMS_INDEX + 9) // 15
#define SRC_AIRFLOW_INDEX                   (TILE_BASE_PARAMS_INDEX + 10) // 16    
#define SRC_MAP_MASK_INDEX                  (TILE_BASE_PARAMS_INDEX + 11) // 17

// Airflow texture.
#define DST_TEMP_TEX_INDEX                  (TILE_BASE_PARAMS_INDEX + 12) // 18
#define DST_MOISTURE_TEX_INDEX              (TILE_BASE_PARAMS_INDEX + 13) // 19
#define DST_PRESSURE_TEX_INDEX              (TILE_BASE_PARAMS_INDEX + 14) // 20
#define DST_AIRFLOW_TEX_INDEX               (TILE_BASE_PARAMS_INDEX + 15) // 21
#define DST_CLOUD_LIGHTING_TEX_INDEX        (TILE_BASE_PARAMS_INDEX + 16) // 22  
#define DST_CLOUD_SHADOW_TEX_INDEX          (TILE_BASE_PARAMS_INDEX + 17) // 23
#define SRC_TEMP_TEX_INDEX                  (TILE_BASE_PARAMS_INDEX + 18) // 24
#define SRC_MOISTURE_TEX_INDEX              (TILE_BASE_PARAMS_INDEX + 19) // 25
#define SRC_PRESSURE_TEX_INDEX              (TILE_BASE_PARAMS_INDEX + 20) // 26
#define SRC_CLOUD_LIGHTING_TEX_INDEX        (TILE_BASE_PARAMS_INDEX + 21) // 27
#define SRC_CLOUD_SHADOW_TEX_INDEX          (TILE_BASE_PARAMS_INDEX + 22) // 28
#define DST_FOG_CLOUD_INDEX                 (TILE_BASE_PARAMS_INDEX + 23) // 29
#define DST_SCATTERING_LUT_INDEX            (TILE_BASE_PARAMS_INDEX + 24) // 30   
#define DST_SCATTERING_LUT_SUM_INDEX        (TILE_BASE_PARAMS_INDEX + 24) // 30
#define SRC_SCATTERING_LUT_INDEX            (TILE_BASE_PARAMS_INDEX + 25) // 31
#define SRC_SCATTERING_LUT_SUM_INDEX        (TILE_BASE_PARAMS_INDEX + 25) // 31

#define DETAIL_NOISE_TEXTURE_INDEX          (TILE_BASE_PARAMS_INDEX + 26) // 32
#define ROUGH_NOISE_TEXTURE_INDEX           (TILE_BASE_PARAMS_INDEX + 27) // 33
#define PERMUTATION_TEXTURE_INDEX           (TILE_BASE_PARAMS_INDEX + 28) // 34     
#define PERMUTATION_2D_TEXTURE_INDEX        (TILE_BASE_PARAMS_INDEX + 29) // 35
#define GRAD_TEXTURE_INDEX                  (TILE_BASE_PARAMS_INDEX + 30) // 36
#define PERM_GRAD_TEXTURE_INDEX             (TILE_BASE_PARAMS_INDEX + 31) // 37
#define PERM_GRAD_4D_TEXTURE_INDEX          (TILE_BASE_PARAMS_INDEX + 32) // 38
#define GRAD_4D_TEXTURE_INDEX               (TILE_BASE_PARAMS_INDEX + 33) // 39
