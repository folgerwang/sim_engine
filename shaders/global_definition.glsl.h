...
#define SPECULAR_TEX_INDEX          EMISSIVE_TEX_INDEX // 11
#define GLOSSNESS_TEX_INDEX         METAL_ROUGHNESS_TEX_INDEX // 10
#define DST_COLOR_TEX_INDEX         (OCCLUSION_TEX_INDEX + 1) // 13
#define DST_WEIGHT_TEX_INDEX        (DST_COLOR_TEX_INDEX + 1) // 14
#define SRC_WEIGHT_TEX_INDEX        (DST_WEIGHT_TEX_INDEX + 1) // 15

#define CONEMAP_TEX_INDEX           (SRC_WEIGHT_TEX_INDEX + 1) // 16
#define PRT_PACK_TEX_INDEX          (CONEMAP_TEX_INDEX + 1) // 17
#define PRT_PACK_INFO_TEX_INDEX     (PRT_PACK_TEX_INDEX + 1) // 18
