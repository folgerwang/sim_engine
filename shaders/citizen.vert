...
layout(location = 16) in vec4 in_draw0;
layout(location = 17) in vec4 in_draw1;
layout(location = 18) in vec4 in_draw2;
layout(location = 19) in vec4 in_last0;
layout(location = 20) in vec4 in_last1;
layout(location = 21) in vec4 in_last2;
