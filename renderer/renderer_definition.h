...
#define SET_6_FLAG_BITS(type, name1, name2, name3, name4, name5, name6) (SET_3_FLAG_BITS(type, name1, name2, name3) | SET_3_FLAG_BITS(type, name4, name5, name6))
...
typedef uint64_t AccelerationStructure;
...
typedef uint32_t MemoryAllocateFlags;
...
typedef uint32_t GeometryFlags;
...
enum BuildAccelerationStructureFlagBits {
...
typedef uint32_t BuildAccelerationStructureFlags;

enum BuildAccelerationStructureMode {
    BUILD_KHR = 0,
    UPDATE_KHR = 1,
    BUILD_ACCELERATION_STRUCTURE_MAX_ENUM_KHR = 0x7FFFFFFF
};
